...
Ftybr.prototype.requestListener = function (req, res) {
  this._applyMiddleware(this._middlewareList(), req, res, this._runAction.bind(this));
};
...
Ftybr.prototype._runAction = function (req, res) {
...
Ftybr.prototype._httpError = function (req, res, statusCode) {
  res.statusCode = statusCode;
  this._errorHandlers[statusCode](req, res);
};
